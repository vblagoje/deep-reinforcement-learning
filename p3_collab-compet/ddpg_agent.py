...
class Agent:
    ...
    def __init__(self, agent_id, state_size, action_size, random_seed=0, gamma=0.99, tau=6e-2,
                 replay_buffer_size=int(1e6), batch_size=128, lr_actor=1e-3, lr_critic=1e-3):
        ...
        # Replay memory
        self.memory = ReplayBuffer(self.action_size, replay_buffer_size, self.batch_size, self.seed)
